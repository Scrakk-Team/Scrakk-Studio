...
- **kolargrep-core** — Library: trigram index, on-disk format, walker, query planner
- **kolargrep-cli** — Binary: CLI parsing, search output, TCP server, file watcher
...
- Relevant log output (run with `kolargrep serve` to see `[trace]` logs)
