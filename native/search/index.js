...
const { ensureIndex, indexStatus, watchRoot, unwatchRoot, searchFiles, grepFiles } = nativeBinding

module.exports.ensureIndex = ensureIndex
module.exports.indexStatus = indexStatus
module.exports.watchRoot = watchRoot
module.exports.unwatchRoot = unwatchRoot
