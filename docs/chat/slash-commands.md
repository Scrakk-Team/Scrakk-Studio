...
group: chat
order: 20
summary: "Comandos que empiezan con `/`: cualquier input puede ejecutarlos y registrar los suyos. El registry no sabe de UI; cada input decide cómo mostrar el resultado."
---
