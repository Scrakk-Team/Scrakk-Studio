...
group: extensions
order: 70
summary: "El header de un panel (PanelFrame) muestra el título y, a la derecha, los botones de acción que el panel declara. Se pueden arrastrar para reordenarlos, con el mismo drag que la activity bar."
---
